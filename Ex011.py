...
area = larg * alt
tinta = area / 2
print('Sua parede tem a dimensão de {}x{} e sua área é igual a {}m²'.format(larg, alt, area))
print('Para pintar essa parede vc precisará de {:.1f}l de tinta.'.format(tinta))
